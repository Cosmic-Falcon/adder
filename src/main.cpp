...
int main() {
	Polygon poly({{0, 0, 0, 1}, {8, 32, 0, 1}, {0, 64, 0, 1}, {32, 56, 0, 1}, {64, 64, 0, 1}, {56, 32, 0, 1}, {64, 0, 0, 1}, {32, 8, 0, 1}}, {256, 128, 0, 1});
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, poly.get_indices_size(), poly.get_indices(), GL_STATIC_DRAW);
